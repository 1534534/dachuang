...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formWidget.setGeometry(QtCore.QRect(20, 90, 331, 211))
        ...
        self.pushButton.setGeometry(QtCore.QRect(160, 310, 71, 23))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.setStyleSheet("border:2px groove gray;border-radius:10px;padding:6px 12px;")
...
"font: 75 14pt \"Arial\";")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "肺结核空洞检测系统-注册"))
        #Form.setStyleSheet("#Form{border-image:url(1413012235-43G.png)}")
